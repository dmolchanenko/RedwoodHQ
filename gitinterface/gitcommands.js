...
exports.add = function(workdir,file,callback){
    ...
    var git  = spawn('vendor/Git/bin/git.exe',['add',file],{cwd: workdir,timeout:300000});
...
exports.commit = function(workdir,file,callback){
    ...
    var git  = spawn('vendor/Git/bin/git.exe',['commit',file,'-m','auto comment'],{cwd: workdir,timeout:300000});
...
exports.delete = function(workdir,callback){
    ...
    var git  = spawn('vendor/Git/bin/git.exe',['commit','-a','-m','files/file removed'],{cwd: workdir,timeout:300000});
